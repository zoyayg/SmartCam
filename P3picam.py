...
# import StringIO #----> works in python 2 only

import io # works in Python3
import subprocess
import os
import time
...
filepath = "" # Type in your picture directory
...
def captureTestImage(settings, width, height):
    ...
    # imageData = StringIO.StringIO() # -----> Python2 version
...
def motion():
    ...
    while (True):
        ...
        if takePicture:
            lastCapture = time.time()
            # this is the line that takes the pictures initially
